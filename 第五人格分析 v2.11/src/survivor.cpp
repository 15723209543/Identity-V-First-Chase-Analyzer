...
survivor::survivor()
    : data_{}, region_id_(0), position_x_(0), position_y_(0)
{
}

survivor::survivor(const survivor_static_data& data, int region_id)
    : data_(data), region_id_(region_id), position_x_(0), position_y_(0)
{
}

survivor::survivor(const survivor_static_data& data, int region_id, int position_x, int position_y)
    : data_(data), region_id_(region_id), position_x_(position_x), position_y_(position_y)
{
}
...
int survivor::position_x() const { return position_x_; }
int survivor::position_y() const { return position_y_; }
