...
void model_params_loader::apply_value(model_params& params, const std::string& key, double value)
{
    ...
    else if (key == "teammate_weight") params.teammate_weight = value;
    else if (key == "softmax_divisor") params.softmax_divisor = value;
    else if (key == "hunter_move_speed_mps") params.hunter_move_speed_mps = value;
    else if (key == "base_first_hit_seconds") params.base_first_hit_seconds = value;
    else if (key == "base_second_hit_seconds") params.base_second_hit_seconds = value;
    else if (key == "hit_recovery_seconds") params.hit_recovery_seconds = value;
    else if (key == "character_time_weight") params.character_time_weight = value;
    else if (key == "hunter_time_weight") params.hunter_time_weight = value;
    else if (key == "map_time_weight") params.map_time_weight = value;
    else if (key == "counter_time_weight") params.counter_time_weight = value;
    else if (key == "teammate_time_weight") params.teammate_time_weight = value;
    else if (key == "resource_time_weight") params.resource_time_weight = value;
    else if (key == "min_first_hit_seconds") params.min_first_hit_seconds = value;
    else if (key == "min_down_seconds") params.min_down_seconds = value;
    ...
    else if (key == "teammate_near_m") params.teammate_near_m = value;
    else if (key == "assist_protection_penalty") params.assist_protection_penalty = value;
    else if (key == "rescue_protection_penalty") params.rescue_protection_penalty = value;
    else if (key == "decoder_isolated_bonus") params.decoder_isolated_bonus = value;
    else if (key == "assist_near_decoder_bonus") params.assist_near_decoder_bonus = value;
    else if (key == "rescue_near_decoder_bonus") params.rescue_near_decoder_bonus = value;
